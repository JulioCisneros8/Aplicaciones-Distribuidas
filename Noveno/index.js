...
app.post("/receipt/insert", async function (req, res) {
  ...
  try {
    ...
    if (!proyecto.id || !proyecto.nombre || !proyecto.descripcion || !proyecto.autores || !proyecto.asesores || !proyecto.presupuesto) {
      return res.json({
...
app.delete("/receipt/delete/:id", async function (req, res) {
  ...
  try {
    ...
    if (deleteResult.deletedCount === 0) {
      result = {
        message: "No se encontró ningún proyecto con ese id",
      };
    } else {
      result = {
